  ...
  return (
    <div className="centerblock__filter filter">
      ...
      <div className="dropdown">
        ...
        <div
          id="myDropdown"
          className={`dropdown-content ${buttons[1] ? 'show' : ''}`}
        >
          {yearFilter}
        </div>
      </div>
      <div className="dropdown">
        ...
        <div
          id="myDropdown"
          className={`dropdown-content ${buttons[2] ? 'show' : ''}`}
        >
          {genreFilter}
        </div>
      </div>
