    ...
    return(
      <div className={styles.main}>
        ...
        <div className={styles.playlist__block}>
            <RightBlockItem loading={loading} fileName="playlist01" altName="day's playlist"/>
            <RightBlockItem loading={loading} fileName="playlist02" altName="day's playlist"/>
            <RightBlockItem loading={loading} fileName="playlist03" altName="day's playlist"/>
        </div>
      </div>
